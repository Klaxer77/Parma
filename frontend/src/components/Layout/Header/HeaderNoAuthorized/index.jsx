...
export default function HeaderNoAuthorized() {
  ...
  return (
    <header className="bg-white h-[90px] border-b-[3px] border-white w-full flex items-center">
      <div className='flex justify-between items-center w-full max-w-[1530px] mx-auto px-[20px] h-[90px]'>
