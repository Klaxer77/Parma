...
export default function Element_9({places}) {
  ...
  return (
    <div
      ...
      className="9 free absolute left-[42px] top-[610px] z-[99] cursor-pointer">
      <img
          className={markers[8].element ? 'marker active -top-[10px] left-[15px]' : 'marker -top-[35px] left-[15px]'}
