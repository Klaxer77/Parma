...
export default function Element_14({places}) {
  ...
  return (
    published &&
    <div
      onClick={() => onClickPlace(12, 12)}
      className="12 free absolute left-[169px] top-[610px] z-[99] cursor-pointer">
      <img
        className={
          markers[11].element
            ? 'marker active -top-[10px] left-[14px]'
            : 'marker -top-[30px] z-0 left-[14px]'
        }
