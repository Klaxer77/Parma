...
export default function Element_6({ places }) {
  ...
  return (
    published &&
    <div
      onClick={() => onClickPlace(22, 22)}
      className="22 free absolute left-[590px] top-[70px] z-[99] cursor-pointer">
      <img
        className={
          markers[21].element
            ? 'marker active -top-[0px] left-[6px]'
            : 'marker -top-[20px] left-[6px]'
        }
