...
export default function Element_13({ places }) {
  ...
  return (
    published &&
    <div onClick={() => onClickPlace(11, 11)} className="11 free absolute left-[206px] top-[586px] z-[99] cursor-pointer">
      <img
        className={
          markers[10].element
            ? 'marker active top-0 left-[5px]'
