...
export default function Element_25({places}) {
  ...
  return (
    published &&
    <div onClick={() => onClickPlace(15, 15)} className="15 free absolute left-[243px] top-[644px] z-[99] cursor-pointer">
      <img
        className={
          markers[14].element
            ? 'marker active -top-[0px] left-[5px]'
            : 'marker -top-[20px] z-0 left-[5px]'
        }
      ...
      {status === 'Свободно' ? (
        ...
        onClick={onClickGrayReservation}
          className="cursor-pointer rotate-[-124deg]"
          width="49"
          height="40"
          viewBox="0 0 49 40"
          fill="none"
