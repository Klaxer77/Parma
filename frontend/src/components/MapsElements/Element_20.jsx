...
export default function Element_20({places}) {
  ...
  return (
    published &&
    <div onClick={() => onClickPlace(4, 4)} className="4 free absolute left-[1325px] top-[475px] z-[99] cursor-pointer">
      <img
        className={
          markers[3].element
