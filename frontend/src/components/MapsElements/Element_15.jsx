...
export default function Element_15({places}) {
  ...
  return (
    published &&
    <div onClick={() => onClickPlace(25, 25)} className="26 free absolute left-[600px] top-[310px] z-[99] cursor-pointer">
      <img
        className={
          markers[24].element
