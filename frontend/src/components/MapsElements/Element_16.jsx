...
export default function Element_16({places}) {
  ...
  return (
    published &&
    <div onClick={() => onClickPlace(26, 26)} className="26 free absolute left-[670px] top-[310px] z-[99] cursor-pointer">
      <img
        className={
          markers[25].element
