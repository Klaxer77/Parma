...
export default function Element_11({places}) {
  ...
  return (
    published &&
    <div
      onClick={() => onClickPlace(9, 9)}
      className="9 free absolute left-[170px] top-[528px] z-[99] cursor-pointer">
        <img
        className={
          markers[8].element
